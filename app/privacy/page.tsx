  ...
  return (
    <main className="mx-auto max-w-4xl px-5 py-16">
      ...
      <div className="mt-10 space-y-9 rounded-3xl border border-white/10 bg-slate-900/70 p-6 md:p-10">
        ...
        <section><h2 className="text-xl font-bold">外部サービスへの送信</h2><p className="mt-3 leading-8 text-slate-300">サービス提供のため、認証・データ保存にSupabase、ホスティングにVercel、AI回答生成にGoogle Gemini APIを利用します。広告配信を有効にした場合はGoogle AdSenseを利用します。会話内容は回答生成のためGoogleのAPIへ送信されます。機密情報や不要な個人情報を入力しないでください。</p></section>
