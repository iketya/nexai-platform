...
const sections = [
  ...
  ["8. 有料プラン", "Proプランは月単位の自動更新です。料金、支払時期、提供条件は料金ページおよび特定商取引法に基づく表記に示します。利用者は契約管理画面からいつでも解約でき、原則として現在の請求期間終了まで利用できます。"],
  ["9. 免責・責任制限", "運営者はサービスの完全性、正確性、特定目的への適合性を保証しません。法令で認められる範囲で、間接損害や特別損害について責任を負いません。"],
  ["10. 規約変更", "必要に応じて本規約を変更できます。利用者に重大な影響がある変更は、効力発生日までにサービス上で案内します。"],
  ["11. 準拠法", "本規約は日本法に準拠します。紛争が生じた場合は、運営者の所在地を管轄する日本の裁判所を第一審の専属的合意管轄裁判所とします。"],
];
