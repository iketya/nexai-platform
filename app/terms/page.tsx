...
const sections = [
  ...
  ["8. 有料プラン", "Proプランは月単位の自動更新です。料金、支払時期、提供条件は料金ページおよび特定商取引法に基づく表記に示します。利用者は契約管理画面からいつでも解約でき、原則として現在の請求期間終了まで利用できます。デジタルサービスの性質上、提供開始後の利用者都合による返金は行いません。ただし、法令上必要な場合または当サービスの責に帰すべき事由がある場合を除きます。"],
  ...
  ["12. お問い合わせ・退会", "問い合わせ、権利侵害の報告、アカウントおよび関連データの削除依頼は、お問い合わせページに記載した窓口で受け付けます。契約中の利用者は、退会前に契約管理画面からProプランを解約してください。"],
];
